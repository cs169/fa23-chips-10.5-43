...
Rails.application.routes.draw do
    ...
    get '/search/(:address)' => 'search#search_representatives', :as => 'search_representatives'

    # Routes for CampaignFinance
    get '/search/cycle/:cycle/category/:category' => 'search#search_campaign_finances', :as => 'search_campaign_finances'
end
